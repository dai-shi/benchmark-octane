...
function GameBoyCore(canvas, ROMImage) {
  ...
  this.DISPLAYOFFCONTROL = [parentObj => {
...
GameBoyCore.prototype.initializeLCDController = function () {
  ...
  while (line < 154) {
    if (line < 143) {
      ...
      this.LINECONTROL[143] = parentObj => {
        if (parentObj.LCDTicks < 80) {
          parentObj.scanLineMode2();
        }
        else if (parentObj.LCDTicks < 252) {
      ...
      this.LINECONTROL[153] = parentObj => {
...
GameBoyCore.prototype.RGBTint = value => {
  ...
  for (var index = 0x0000; index <= 0xFFFF; index++) {
    if (index < 0x4000) {
      ...
      switch (index) {
        case 0xFF00:
          //JOYPAD:
          this.memoryHighReader[0] = this.memoryReader[0xFF00] = (parentObj, address) => //Top nibble returns as set.
          0xC0 | parentObj.memory[0xFF00]
          break;
        case 0xFF01:
          //SB
          this.memoryHighReader[0x01] = this.memoryReader[0xFF01] = (parentObj, address) => (parentObj.memory[0xFF02] < 0x80) ? parentObj.memory[0xFF01] : 0xFF
          break;
        case 0xFF02:
          //SC
          if (this.cGBC) {
            this.memoryHighReader[0x02] = this.memoryReader[0xFF02] = (parentObj, address) => ((parentObj.serialTimer <= 0) ? 0x7C : 0xFC) | parentObj.memory[0xFF02]
          }
          else {
            this.memoryHighReader[0x02] = this.memoryReader[0xFF02] = (parentObj, address) => ((parentObj.serialTimer <= 0) ? 0x7E : 0xFE) | parentObj.memory[0xFF02]
          }
          break;
        case 0xFF04:
          //DIV
          this.memoryHighReader[0x04] = this.memoryReader[0xFF04] = (parentObj, address) => {
          ...
          break;
        case 0xFF07:
          this.memoryHighReader[0x07] = this.memoryReader[0xFF07] = (parentObj, address) => 0xF8 | parentObj.memory[0xFF07]
          break;
        case 0xFF0F:
          //IF
          this.memoryHighReader[0x0F] = this.memoryReader[0xFF0F] = (parentObj, address) => 0xE0 | parentObj.interruptsRequested
          break;
        case 0xFF10:
          this.memoryHighReader[0x10] = this.memoryReader[0xFF10] = (parentObj, address) => 0x80 | parentObj.memory[0xFF10]
          break;
        case 0xFF11:
          this.memoryHighReader[0x11] = this.memoryReader[0xFF11] = (parentObj, address) => 0x3F | parentObj.memory[0xFF11]
          break;
        case 0xFF13:
          this.memoryHighReader[0x13] = this.memoryReader[0xFF13] = this.memoryReadBAD;
          break;
        case 0xFF14:
          this.memoryHighReader[0x14] = this.memoryReader[0xFF14] = (parentObj, address) => 0xBF | parentObj.memory[0xFF14]
          break;
        case 0xFF16:
          this.memoryHighReader[0x16] = this.memoryReader[0xFF16] = (parentObj, address) => 0x3F | parentObj.memory[0xFF16]
          break;
        case 0xFF18:
          this.memoryHighReader[0x18] = this.memoryReader[0xFF18] = this.memoryReadBAD;
          break;
        case 0xFF19:
          this.memoryHighReader[0x19] = this.memoryReader[0xFF19] = (parentObj, address) => 0xBF | parentObj.memory[0xFF19]
          break;
        case 0xFF1A:
          this.memoryHighReader[0x1A] = this.memoryReader[0xFF1A] = (parentObj, address) => 0x7F | parentObj.memory[0xFF1A]
          break;
        case 0xFF1B:
          this.memoryHighReader[0x1B] = this.memoryReader[0xFF1B] = this.memoryReadBAD;
          break;
        case 0xFF1C:
          this.memoryHighReader[0x1C] = this.memoryReader[0xFF1C] = (parentObj, address) => 0x9F | parentObj.memory[0xFF1C]
          break;
        case 0xFF1D:
          this.memoryHighReader[0x1D] = this.memoryReader[0xFF1D] = (parentObj, address) => 0xFF
          break;
        case 0xFF1E:
          this.memoryHighReader[0x1E] = this.memoryReader[0xFF1E] = (parentObj, address) => 0xBF | parentObj.memory[0xFF1E]
          break;
        case 0xFF1F:
        case 0xFF20:
          ...
          break;
        case 0xFF23:
          this.memoryHighReader[0x23] = this.memoryReader[0xFF23] = (parentObj, address) => 0xBF | parentObj.memory[0xFF23]
          break;
        case 0xFF26:
          this.memoryHighReader[0x26] = this.memoryReader[0xFF26] = (parentObj, address) => {
            parentObj.audioJIT();
        ...
        case 0xFF3E:
        case 0xFF3F:
          this.memoryReader[index] = (parentObj, address) => (parentObj.channel3canPlay) ? parentObj.memory[0xFF00 | (parentObj.channel3lastSampleLookup >> 1)] : parentObj.memory[address]
          this.memoryHighReader[index & 0xFF] = (parentObj, address) => (parentObj.channel3canPlay) ? parentObj.memory[0xFF00 | (parentObj.channel3lastSampleLookup >> 1)] : parentObj.memory[0xFF00 | address]
          break;
        case 0xFF41:
          this.memoryHighReader[0x41] = this.memoryReader[0xFF41] = (parentObj, address) => 0x80 | parentObj.memory[0xFF41] | parentObj.modeSTAT
          break;
        case 0xFF42:
          this.memoryHighReader[0x42] = this.memoryReader[0xFF42] = (parentObj, address) => parentObj.backgroundY
          break;
        case 0xFF43:
          this.memoryHighReader[0x43] = this.memoryReader[0xFF43] = (parentObj, address) => parentObj.backgroundX
          break;
        case 0xFF44:
          this.memoryHighReader[0x44] = this.memoryReader[0xFF44] = (parentObj, address) => (parentObj.LCDisOn) ? parentObj.memory[0xFF44] : 0
          break;
        case 0xFF4A:
          //WY
          this.memoryHighReader[0x4A] = this.memoryReader[0xFF4A] = (parentObj, address) => parentObj.windowY
          break;
        case 0xFF4F:
          this.memoryHighReader[0x4F] = this.memoryReader[0xFF4F] = (parentObj, address) => parentObj.currVRAMBank
          break;
        case 0xFF55:
          if (this.cGBC) {
            this.memoryHighReader[0x55] = this.memoryReader[0xFF55] = (parentObj, address) => {
        ...
        case 0xFF56:
          if (this.cGBC) {
            this.memoryHighReader[0x56] = this.memoryReader[0xFF56] = (parentObj, address) => //Return IR "not connected" status:
            0x3C | ((parentObj.memory[0xFF56] >= 0xC0 ? 0x2 | (parentObj.memory[0xFF56] & 0xC1) : parentObj.memory[0xFF56] & 0xC3))
          }
          else {
        ...
        case 0xFF6C:
          if (this.cGBC) {
            this.memoryHighReader[0x6C] = this.memoryReader[0xFF6C] = (parentObj, address) => 0xFE | parentObj.memory[0xFF6C]
          }
          else {
        ...
        case 0xFF70:
          if (this.cGBC) {
            //SVBK
            this.memoryHighReader[0x70] = this.memoryReader[0xFF70] = (parentObj, address) => 0x40 | parentObj.memory[0xFF70]
          }
          else {
          ...
          break;
        case 0xFF75:
          this.memoryHighReader[0x75] = this.memoryReader[0xFF75] = (parentObj, address) => 0x8F | parentObj.memory[0xFF75]
          break;
        case 0xFF76:
        case 0xFF77:
          this.memoryHighReader[index & 0xFF] = this.memoryReader[index] = (parentObj, address) => 0
          break;
        case 0xFFFF:
          //IE
          this.memoryHighReader[0xFF] = this.memoryReader[0xFFFF] = (parentObj, address) => parentObj.interruptsEnabled
          break;
        default:
          this.memoryReader[index] = this.memoryReadNormal;
...
GameBoyCore.prototype.memoryReadNormal = (parentObj, address) => parentObj.memory[address]
GameBoyCore.prototype.memoryHighReadNormal = (parentObj, address) => parentObj.memory[0xFF00 | address]
GameBoyCore.prototype.memoryReadROM = (parentObj, address) => parentObj.ROM[parentObj.currentROMBank + address]
GameBoyCore.prototype.memoryReadMBC = (parentObj, address) => {
  //Switchable RAM
...
GameBoyCore.prototype.memoryReadMBC7 = (parentObj, address) => {
  //Switchable RAM
  if (parentObj.MBCRAMBanksEnabled || settings[10]) {
    switch (address) {
      case 0xA000:
...
GameBoyCore.prototype.memoryReadMBC3 = (parentObj, address) => {
  //Switchable RAM
  if (parentObj.MBCRAMBanksEnabled || settings[10]) {
...
GameBoyCore.prototype.memoryReadGBCMemory = (parentObj, address) => parentObj.GBCMemory[address + parentObj.gbcRamBankPosition]
GameBoyCore.prototype.memoryReadOAM = (parentObj, address) => (parentObj.modeSTAT > 1) ?  0xFF : parentObj.memory[address]
GameBoyCore.prototype.memoryReadECHOGBCMemory = (parentObj, address) => parentObj.GBCMemory[address + parentObj.gbcRamBankPositionECHO]
GameBoyCore.prototype.memoryReadECHONormal = (parentObj, address) => parentObj.memory[address - 0x2000]
GameBoyCore.prototype.memoryReadBAD = (parentObj, address) => 0xFF
GameBoyCore.prototype.VRAMDATAReadCGBCPU = (parentObj, address) => //CPU Side Reading The VRAM (Optimized for GameBoy Color)
(parentObj.modeSTAT > 2 ? 0xFF : (parentObj.currVRAMBank == 0) ? parentObj.memory[address] : parentObj.VRAM[address & 0x1FFF])
GameBoyCore.prototype.VRAMDATAReadDMGCPU = (parentObj, address) => //CPU Side Reading The VRAM (Optimized for classic GameBoy)
(parentObj.modeSTAT > 2 ? 0xFF : parentObj.memory[address])
GameBoyCore.prototype.VRAMCHRReadCGBCPU = (parentObj, address) => //CPU Side Reading the Character Data Map:
(parentObj.modeSTAT > 2 ? 0xFF : parentObj.BGCHRCurrentBank[address & 0x7FF])
GameBoyCore.prototype.VRAMCHRReadDMGCPU = (parentObj, address) => //CPU Side Reading the Character Data Map:
(parentObj.modeSTAT > 2 ? 0xFF : parentObj.BGCHRBank1[address & 0x7FF])
...
GameBoyCore.prototype.MBC1WriteType = (parentObj, address, data) => {
  //MBC1 mode setting:
...
GameBoyCore.prototype.MBC2WriteROMBank = (parentObj, address, data) => {
  //MBC2 ROM bank switching:
  parentObj.ROMBank1offs = data & 0x0F;
  parentObj.setCurrentMBC2AND3ROMBank();
}
GameBoyCore.prototype.MBC3WriteROMBank = (parentObj, address, data) => {
  //MBC3 ROM bank switching:
  parentObj.ROMBank1offs = data & 0x7F;
  parentObj.setCurrentMBC2AND3ROMBank();
}
GameBoyCore.prototype.MBC3WriteRAMBank = (parentObj, address, data) => {
...
GameBoyCore.prototype.MBC3WriteRTCLatch = (parentObj, address, data) => {
  if (data == 0) {
...
GameBoyCore.prototype.MBC5WriteROMBankLow = (parentObj, address, data) => {
  //MBC5 ROM bank switching:
  parentObj.ROMBank1offs = (parentObj.ROMBank1offs & 0x100) | data;
  parentObj.setCurrentMBC5ROMBank();
}
GameBoyCore.prototype.MBC5WriteROMBankHigh = (parentObj, address, data) => {
  //MBC5 ROM bank switching (by least significant bit):
  parentObj.ROMBank1offs  = ((data & 0x01) << 8) | (parentObj.ROMBank1offs & 0xFF);
  parentObj.setCurrentMBC5ROMBank();
}
GameBoyCore.prototype.MBC5WriteRAMBank = (parentObj, address, data) => {
  //MBC5 RAM bank switching
  parentObj.currMBCRAMBank = data & 0xF;
  parentObj.currMBCRAMBankPosition = (parentObj.currMBCRAMBank << 13) - 0xA000;
}
GameBoyCore.prototype.RUMBLEWriteRAMBank = (parentObj, address, data) => {
  //MBC5 RAM bank switching
  //Like MBC5, but bit 3 of the lower nibble is used for rumbling and bit 2 is ignored.
  parentObj.currMBCRAMBank = data & 0x03;
  parentObj.currMBCRAMBankPosition = (parentObj.currMBCRAMBank << 13) - 0xA000;
}
GameBoyCore.prototype.HuC3WriteRAMBank = (parentObj, address, data) => {
  //HuC3 RAM bank switching
  parentObj.currMBCRAMBank = data & 0x03;
  parentObj.currMBCRAMBankPosition = (parentObj.currMBCRAMBank << 13) - 0xA000;
}
GameBoyCore.prototype.cartIgnoreWrite = (parentObj, address, data) => {
  //We might have encountered illegal RAM writing or such, so just do nothing...
}
GameBoyCore.prototype.memoryWriteNormal = (parentObj, address, data) => {
  parentObj.memory[address] = data;
}
GameBoyCore.prototype.memoryHighWriteNormal = (parentObj, address, data) => {
  parentObj.memory[0xFF00 | address] = data;
}
GameBoyCore.prototype.memoryWriteMBCRAM = (parentObj, address, data) => {
  if (parentObj.MBCRAMBanksEnabled || settings[10]) {
    parentObj.MBCRam[address + parentObj.currMBCRAMBankPosition] = data;
  }
}
GameBoyCore.prototype.memoryWriteMBC3RAM = (parentObj, address, data) => {
  if (parentObj.MBCRAMBanksEnabled || settings[10]) {
    switch (parentObj.currMBCRAMBank) {
      case 0x00:
      case 0x01:
...
GameBoyCore.prototype.memoryWriteGBCRAM = (parentObj, address, data) => {
  parentObj.GBCMemory[address + parentObj.gbcRamBankPosition] = data;
}
GameBoyCore.prototype.memoryWriteOAMRAM = (parentObj, address, data) => {
...
GameBoyCore.prototype.memoryWriteECHOGBCRAM = (parentObj, address, data) => {
  parentObj.GBCMemory[address + parentObj.gbcRamBankPositionECHO] = data;
}
GameBoyCore.prototype.memoryWriteECHONormal = (parentObj, address, data) => {
  parentObj.memory[address - 0x2000] = data;
}
GameBoyCore.prototype.VRAMGBDATAWrite = (parentObj, address, data) => {
...
GameBoyCore.prototype.VRAMGBDATAUpperWrite = (parentObj, address, data) => {
  if (parentObj.modeSTAT < 3) {  //VRAM cannot be written to during mode 3
    if (parentObj.memory[address] != data) {
      //JIT the graphics render queue:
      parentObj.graphicsJIT();
...
GameBoyCore.prototype.VRAMGBCDATAWrite = (parentObj, address, data) => {
  if (parentObj.modeSTAT < 3) {  //VRAM cannot be written to during mode 3
...
GameBoyCore.prototype.VRAMGBCHRMAPWrite = (parentObj, address, data) => {
  if (parentObj.modeSTAT < 3) {  //VRAM cannot be written to during mode 3
    address &= 0x7FF;
...
GameBoyCore.prototype.VRAMGBCCHRMAPWrite = (parentObj, address, data) => {
  if (parentObj.modeSTAT < 3) {  //VRAM cannot be written to during mode 3
    address &= 0x7FF;
...
GameBoyCore.prototype.registerWriteJumpCompile = function () {
  ...
  //JoyPad
  this.memoryHighWriter[0] = this.memoryWriter[0xFF00] = (parentObj, address, data) => {
    parentObj.memory[0xFF00] = (data & 0x30) | ((((data & 0x20) == 0) ? (parentObj.JoyPad >> 4) : 0xF) & (((data & 0x10) == 0) ? (parentObj.JoyPad & 0xF) : 0xF));
  }
  //SB (Serial Transfer Data)
  this.memoryHighWriter[0x1] = this.memoryWriter[0xFF01] = (parentObj, address, data) => {
    if (parentObj.memory[0xFF02] < 0x80) {  //Cannot write while a serial transfer is active.
      parentObj.memory[0xFF01] = data;
    }
  }
  //DIV
  this.memoryHighWriter[0x4] = this.memoryWriter[0xFF04] = (parentObj, address, data) => {
    parentObj.DIVTicks &= 0xFF;  //Update DIV for realignment.
    parentObj.memory[0xFF04] = 0;
  }
  //TIMA
  this.memoryHighWriter[0x5] = this.memoryWriter[0xFF05] = (parentObj, address, data) => {
    parentObj.memory[0xFF05] = data;
  }
  //TMA
  this.memoryHighWriter[0x6] = this.memoryWriter[0xFF06] = (parentObj, address, data) => {
    parentObj.memory[0xFF06] = data;
  }
  //TAC
  this.memoryHighWriter[0x7] = this.memoryWriter[0xFF07] = (parentObj, address, data) => {
    parentObj.memory[0xFF07] = data & 0x07;
    parentObj.TIMAEnabled = (data & 0x04) == 0x04;
    parentObj.TACClocker = 4 ** (((data & 0x3) != 0 ? data & 0x3 : 4)) << 2;  //TODO: Find a way to not make a conditional in here...
  }
  //IF (Interrupt Request)
  this.memoryHighWriter[0xF] = this.memoryWriter[0xFF0F] = (parentObj, address, data) => {
    parentObj.interruptsRequested = data;
    parentObj.checkIRQMatching();
  }
  this.memoryHighWriter[0x10] = this.memoryWriter[0xFF10] = (parentObj, address, data) => {
  ...
  this.memoryHighWriter[0x11] = this.memoryWriter[0xFF11] = (parentObj, address, data) => {
  ...
  this.memoryHighWriter[0x12] = this.memoryWriter[0xFF12] = (parentObj, address, data) => {
    if (parentObj.soundMasterEnabled) {
      parentObj.audioJIT();
  ...
  this.memoryHighWriter[0x13] = this.memoryWriter[0xFF13] = (parentObj, address, data) => {
    if (parentObj.soundMasterEnabled) {
      parentObj.audioJIT();
  ...
  this.memoryHighWriter[0x14] = this.memoryWriter[0xFF14] = (parentObj, address, data) => {
    if (parentObj.soundMasterEnabled) {
      parentObj.audioJIT();
  ...
  this.memoryHighWriter[0x16] = this.memoryWriter[0xFF16] = (parentObj, address, data) => {
    if (parentObj.soundMasterEnabled || !parentObj.cGBC) {
      if (parentObj.soundMasterEnabled) {
        parentObj.audioJIT();
      }
  ...
  this.memoryHighWriter[0x17] = this.memoryWriter[0xFF17] = (parentObj, address, data) => {
    if (parentObj.soundMasterEnabled) {
      parentObj.audioJIT();
  ...
  this.memoryHighWriter[0x18] = this.memoryWriter[0xFF18] = (parentObj, address, data) => {
    if (parentObj.soundMasterEnabled) {
      parentObj.audioJIT();
  ...
  this.memoryHighWriter[0x19] = this.memoryWriter[0xFF19] = (parentObj, address, data) => {
    if (parentObj.soundMasterEnabled) {
      parentObj.audioJIT();
      if (data > 0x7F) {
        //Reload 0xFF17:
  ...
  this.memoryHighWriter[0x1A] = this.memoryWriter[0xFF1A] = (parentObj, address, data) => {
    if (parentObj.soundMasterEnabled) {
      parentObj.audioJIT();
  ...
  this.memoryHighWriter[0x1B] = this.memoryWriter[0xFF1B] = (parentObj, address, data) => {
    if (parentObj.soundMasterEnabled || !parentObj.cGBC) {
      if (parentObj.soundMasterEnabled) {
        parentObj.audioJIT();
      }
  ...
  this.memoryHighWriter[0x1C] = this.memoryWriter[0xFF1C] = (parentObj, address, data) => {
    if (parentObj.soundMasterEnabled) {
      parentObj.audioJIT();
      data &= 0x60;
  ...
  this.memoryHighWriter[0x1D] = this.memoryWriter[0xFF1D] = (parentObj, address, data) => {
    if (parentObj.soundMasterEnabled) {
      parentObj.audioJIT();
  ...
  this.memoryHighWriter[0x1E] = this.memoryWriter[0xFF1E] = (parentObj, address, data) => {
    if (parentObj.soundMasterEnabled) {
      parentObj.audioJIT();
      if (data > 0x7F) {
  ...
  this.memoryHighWriter[0x20] = this.memoryWriter[0xFF20] = (parentObj, address, data) => {
    if (parentObj.soundMasterEnabled || !parentObj.cGBC) {
      if (parentObj.soundMasterEnabled) {
        parentObj.audioJIT();
      }
  ...
  this.memoryHighWriter[0x21] = this.memoryWriter[0xFF21] = (parentObj, address, data) => {
    if (parentObj.soundMasterEnabled) {
      parentObj.audioJIT();
  ...
  this.memoryHighWriter[0x22] = this.memoryWriter[0xFF22] = (parentObj, address, data) => {
    if (parentObj.soundMasterEnabled) {
      parentObj.audioJIT();
  ...
  this.memoryHighWriter[0x23] = this.memoryWriter[0xFF23] = (parentObj, address, data) => {
    if (parentObj.soundMasterEnabled) {
      parentObj.audioJIT();
  ...
  this.memoryHighWriter[0x24] = this.memoryWriter[0xFF24] = (parentObj, address, data) => {
  ...
  this.memoryHighWriter[0x25] = this.memoryWriter[0xFF25] = (parentObj, address, data) => {
  ...
  this.memoryHighWriter[0x26] = this.memoryWriter[0xFF26] = (parentObj, address, data) => {
    parentObj.audioJIT();
  ...
  //WAVE PCM RAM:
  this.memoryHighWriter[0x30] = this.memoryWriter[0xFF30] = (parentObj, address, data) => {
    parentObj.channel3WriteRAM(0, data);
  }
  this.memoryHighWriter[0x31] = this.memoryWriter[0xFF31] = (parentObj, address, data) => {
    parentObj.channel3WriteRAM(0x1, data);
  }
  this.memoryHighWriter[0x32] = this.memoryWriter[0xFF32] = (parentObj, address, data) => {
    parentObj.channel3WriteRAM(0x2, data);
  }
  this.memoryHighWriter[0x33] = this.memoryWriter[0xFF33] = (parentObj, address, data) => {
    parentObj.channel3WriteRAM(0x3, data);
  }
  this.memoryHighWriter[0x34] = this.memoryWriter[0xFF34] = (parentObj, address, data) => {
    parentObj.channel3WriteRAM(0x4, data);
  }
  this.memoryHighWriter[0x35] = this.memoryWriter[0xFF35] = (parentObj, address, data) => {
    parentObj.channel3WriteRAM(0x5, data);
  }
  this.memoryHighWriter[0x36] = this.memoryWriter[0xFF36] = (parentObj, address, data) => {
    parentObj.channel3WriteRAM(0x6, data);
  }
  this.memoryHighWriter[0x37] = this.memoryWriter[0xFF37] = (parentObj, address, data) => {
    parentObj.channel3WriteRAM(0x7, data);
  }
  this.memoryHighWriter[0x38] = this.memoryWriter[0xFF38] = (parentObj, address, data) => {
    parentObj.channel3WriteRAM(0x8, data);
  }
  this.memoryHighWriter[0x39] = this.memoryWriter[0xFF39] = (parentObj, address, data) => {
    parentObj.channel3WriteRAM(0x9, data);
  }
  this.memoryHighWriter[0x3A] = this.memoryWriter[0xFF3A] = (parentObj, address, data) => {
    parentObj.channel3WriteRAM(0xA, data);
  }
  this.memoryHighWriter[0x3B] = this.memoryWriter[0xFF3B] = (parentObj, address, data) => {
    parentObj.channel3WriteRAM(0xB, data);
  }
  this.memoryHighWriter[0x3C] = this.memoryWriter[0xFF3C] = (parentObj, address, data) => {
    parentObj.channel3WriteRAM(0xC, data);
  }
  this.memoryHighWriter[0x3D] = this.memoryWriter[0xFF3D] = (parentObj, address, data) => {
    parentObj.channel3WriteRAM(0xD, data);
  }
  this.memoryHighWriter[0x3E] = this.memoryWriter[0xFF3E] = (parentObj, address, data) => {
    parentObj.channel3WriteRAM(0xE, data);
  }
  this.memoryHighWriter[0x3F] = this.memoryWriter[0xFF3F] = (parentObj, address, data) => {
    parentObj.channel3WriteRAM(0xF, data);
  }
  //SCY
  this.memoryHighWriter[0x42] = this.memoryWriter[0xFF42] = (parentObj, address, data) => {
  ...
  //SCX
  this.memoryHighWriter[0x43] = this.memoryWriter[0xFF43] = (parentObj, address, data) => {
  ...
  //LY
  this.memoryHighWriter[0x44] = this.memoryWriter[0xFF44] = (parentObj, address, data) => {
    //Read Only:
  ...
  //LYC
  this.memoryHighWriter[0x45] = this.memoryWriter[0xFF45] = (parentObj, address, data) => {
  ...
  //WY
  this.memoryHighWriter[0x4A] = this.memoryWriter[0xFF4A] = (parentObj, address, data) => {
  ...
  //WX
  this.memoryHighWriter[0x4B] = this.memoryWriter[0xFF4B] = (parentObj, address, data) => {
  ...
  this.memoryHighWriter[0x72] = this.memoryWriter[0xFF72] = (parentObj, address, data) => {
    parentObj.memory[0xFF72] = data;
  }
  this.memoryHighWriter[0x73] = this.memoryWriter[0xFF73] = (parentObj, address, data) => {
    parentObj.memory[0xFF73] = data;
  }
  this.memoryHighWriter[0x75] = this.memoryWriter[0xFF75] = (parentObj, address, data) => {
  ...
  //IE (Interrupt Enable)
  this.memoryHighWriter[0xFF] = this.memoryWriter[0xFFFF] = (parentObj, address, data) => {
...
GameBoyCore.prototype.recompileModelSpecificIOWriteHandling = function () {
  if (this.cGBC) {
    ...
    this.memoryHighWriter[0x2] = this.memoryWriter[0xFF02] = (parentObj, address, data) => {
      if (((data & 0x1) == 0x1)) {
        //Internal clock:
    ...
    this.memoryHighWriter[0x40] = this.memoryWriter[0xFF40] = (parentObj, address, data) => {
    ...
    this.memoryHighWriter[0x41] = this.memoryWriter[0xFF41] = (parentObj, address, data) => {
    ...
    this.memoryHighWriter[0x46] = this.memoryWriter[0xFF46] = (parentObj, address, data) => {
    ...
    //KEY1
    this.memoryHighWriter[0x4D] = this.memoryWriter[0xFF4D] = (parentObj, address, data) => {
      parentObj.memory[0xFF4D] = (data & 0x7F) | (parentObj.memory[0xFF4D] & 0x80);
    }
    this.memoryHighWriter[0x4F] = this.memoryWriter[0xFF4F] = (parentObj, address, data) => {
    ...
    this.memoryHighWriter[0x51] = this.memoryWriter[0xFF51] = (parentObj, address, data) => {
      if (!parentObj.hdmaRunning) {
        parentObj.memory[0xFF51] = data;
      }
    }
    this.memoryHighWriter[0x52] = this.memoryWriter[0xFF52] = (parentObj, address, data) => {
      if (!parentObj.hdmaRunning) {
        parentObj.memory[0xFF52] = data & 0xF0;
      }
    }
    this.memoryHighWriter[0x53] = this.memoryWriter[0xFF53] = (parentObj, address, data) => {
      if (!parentObj.hdmaRunning) {
        parentObj.memory[0xFF53] = data & 0x1F;
      }
    }
    this.memoryHighWriter[0x54] = this.memoryWriter[0xFF54] = (parentObj, address, data) => {
      if (!parentObj.hdmaRunning) {
        parentObj.memory[0xFF54] = data & 0xF0;
      }
    }
    this.memoryHighWriter[0x55] = this.memoryWriter[0xFF55] = (parentObj, address, data) => {
      if (!parentObj.hdmaRunning) {
        if ((data & 0x80) == 0) {
          //DMA
    ...
    this.memoryHighWriter[0x68] = this.memoryWriter[0xFF68] = (parentObj, address, data) => {
      parentObj.memory[0xFF69] = parentObj.gbcBGRawPalette[data & 0x3F];
      parentObj.memory[0xFF68] = data;
    }
    this.memoryHighWriter[0x69] = this.memoryWriter[0xFF69] = (parentObj, address, data) => {
    ...
    this.memoryHighWriter[0x6A] = this.memoryWriter[0xFF6A] = (parentObj, address, data) => {
      parentObj.memory[0xFF6B] = parentObj.gbcOBJRawPalette[data & 0x3F];
      parentObj.memory[0xFF6A] = data;
    }
    this.memoryHighWriter[0x6B] = this.memoryWriter[0xFF6B] = (parentObj, address, data) => {
    ...
    //SVBK
    this.memoryHighWriter[0x70] = this.memoryWriter[0xFF70] = (parentObj, address, data) => {
    ...
    this.memoryHighWriter[0x74] = this.memoryWriter[0xFF74] = (parentObj, address, data) => {
    ...
    this.memoryHighWriter[0x47] = this.memoryWriter[0xFF47] = (parentObj, address, data) => {
    ...
    this.memoryHighWriter[0x48] = this.memoryWriter[0xFF48] = (parentObj, address, data) => {
    ...
    this.memoryHighWriter[0x49] = this.memoryWriter[0xFF49] = (parentObj, address, data) => {
...
GameBoyCore.prototype.recompileBootIOWriteHandling = function () {
  //Boot I/O Registers:
  if (this.inBootstrap) {
    this.memoryHighWriter[0x50] = this.memoryWriter[0xFF50] = (parentObj, address, data) => {
    ...
    if (this.cGBC) {
      this.memoryHighWriter[0x6C] = this.memoryWriter[0xFF6C] = (parentObj, address, data) => {
...
GameBoyCore.prototype.fromTypedArray = baseArray => {
  try {
    if (!baseArray || !baseArray.length) {
      return [];
    }
...
GameBoyCore.prototype.checkForOperaMathBug = () => {
