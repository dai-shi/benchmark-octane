...
(((window, undefined) => {
    ...
    var jQuery = ((() => {
        ...
        var jQuery = (selector, context) => // The jQuery object is actually just the init constructor 'enhanced'
        ...
        var // Check if a string has a non-whitespace character in it
        rnotwhite = /\S/;

        var // Used for trimming whitespace
        trimLeft = /^\s+/;
        ...
        var // For matching the engine and version of the browser
        browserMatch;
        ...
        jQuery.fn = jQuery.prototype = {
            ...
            slice(...args) {
                return this.pushStack( slice.apply( this, args ),
                    "slice", slice.call(args).join(",") );
            },
    ...
    jQuery.Callbacks = flags => {
        ...
        var // Add one or several callbacks to the list
        add = args => {
			var i,
				length,
				elem,
    ...
    jQuery.extend({
        ...
        Deferred(func) {
            ...
            var promise = {
				...
				always(...args) {
					deferred.done(...args).fail.apply( deferred, args );
					return this;
				},
					...
					return jQuery.Deferred(newDefer => {
						jQuery.each( {
							...
							var fn = data[ 0 ],
								...
								returned;
							if ( jQuery.isFunction( fn ) ) {
								deferred[ handler ](function(...args) {
    ...
    jQuery.extend({
        ...
        removeData(elem, name, pvt /* Internal Use Only */) {
            ...
            var // Reference to internal data cache key
    ...
    ((() => {
        ...
        var Sizzle = (selector, context, results, seed) => {
            results = results || [];
        ...
        Sizzle.matches = (expr, set) => Sizzle( expr, null, null, set );

        Sizzle.matchesSelector = (node, expr) => Sizzle( expr, null, null, [node] ).length > 0;
         ...
         */
        var getText = Sizzle.getText = elem => {
            var i;
            var node;
        ...
        ((() => {
            ...
            if ( div.firstChild && typeof div.firstChild.getAttribute !== "undefined" &&
                ...
                Expr.attrHandle.href = elem => elem.getAttribute( "href", 2 );
            }
        ...
        if ( document.documentElement.contains ) {
            Sizzle.contains = (a, b) => a !== b && (a.contains ? a.contains(b) : true);

        } else if ( document.documentElement.compareDocumentPosition ) {
            Sizzle.contains = (a, b) => !!(a.compareDocumentPosition(b) & 16);

        } else {
            Sizzle.contains = () => false;
        }
        ...
        var posProcess = (selector, context, seed) => {
            var match;
            var tmpSet = [];
            var later = "";
    ...
    var // Note: This RegExp should be improved, or likely pulled from Sizzle
    rmultiselector = /,/;
    ...
    var rnoshimcache = new RegExp("<(?:" + nodeNames + ")", "i");
    ...
    jQuery.fn.extend({
        ...
        before(...args) {
            if ( this[0] && this[0].parentNode ) {
                ...
                return this.pushStack( set, "before", args );
            }
        },
        ...
        after(...args) {
            if ( this[0] && this[0].parentNode ) {
                ...
                var set = this.pushStack( this, "after", args );
                set.push(...jQuery.clean(args));
                return set;
            }
        },
    ...
    jQuery.extend({
        clone(elem, dataAndEvents, deepDataAndEvents) {
            ...
            var // IE<=8 does not properly clone detached, unknown element nodes
        ...
        clean(elems, context, fragment, scripts) {
            ...
            if ( fragment ) {
                checkScriptType = elem => !elem.type || rscriptType.test( elem.type );
                for ( i = 0; ret[i]; i++ ) {
    ...
    var // Document location segments
    ajaxLocParts;
    ...
    function ajaxConvert( s, response ) {
        ...
        var // Current and previous dataTypes
        current = dataTypes[ 0 ];
        ...
        var // Conversion functions (transitive conversion)
        conv1;
